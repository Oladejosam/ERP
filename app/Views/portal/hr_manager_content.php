<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div>
                <h2 class="fw-bold mb-1">HR Manager Portal</h2>
                <p class="text-muted mb-0">Manage employees, departments, and company roles.</p>
            </div>
            <span class="badge text-bg-primary px-3 py-2">Human Resources</span>
        </div>
        <div class="row g-3">
