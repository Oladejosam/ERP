<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div>
                <h2 class="fw-bold mb-1">Logistics Portal</h2>
                <p class="text-muted mb-0">Coordinate inventory, requisitions, procurement, and project deliveries.</p>
            </div>
            <span class="badge bg-success-subtle text-success px-3 py-2 fs-6">Logistics Officer</span>
        </div>
