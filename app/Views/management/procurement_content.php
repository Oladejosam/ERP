...
<div class="card shadow-sm border-0 mb-4"><div class="card-body">
    ...
    <form method="post" action="/ERP/public/management/procurement/create">
        ...
        <button class="btn btn-primary mt-3" type="submit"><i class="bi bi-send me-1"></i>Send for Head Store Approval</button>
    </form>
</div></div>
<?php endif; ?>

<?php if (!empty($canApprovePurchaseOrder)): ?>
<div class="card shadow-sm border-0 mb-4"><div class="card-body"><h5 class="fw-bold mb-3">Purchase Orders Awaiting Approval</h5>
